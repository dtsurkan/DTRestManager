 ...
 */
enum {
	VBISO8601DateFormatCalendar,
	VBISO8601DateFormatOrdinal,
	VBISO8601DateFormatWeek,
};
typedef NSUInteger VBISO8601DateFormat;

@interface VBISO8601DateFormatter: NSFormatter
 ...
 */
@property (nonatomic, assign) VBISO8601DateFormat format;
